...
FORMULA_REGISTRY: dict[str, FormulaDefinition] = {
    ...
    "ttm_sum": _formula("ttm_sum", "TTM = q1 + q2 + q3 + q4; Q4 may be source-reported or derived as annual - Q1 - Q2 - Q3 when all inputs are source-backed", ("q1", "q2", "q3", "q4"), ttm_sum, "currency", ("must use four comparable fiscal quarters", "derived Q4 requires source-backed annual and Q1-Q3 values", *COMMON_UNITS)),
